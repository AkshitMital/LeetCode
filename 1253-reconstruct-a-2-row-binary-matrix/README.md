<h2><a href="https://leetcode.com/problems/reconstruct-a-2-row-binary-matrix">1253. Reconstruct a 2-Row Binary Matrix</a></h2><h3>Medium</h3><hr><p>Given the following details of a matrix with <code>n</code> columns and <code>2</code> rows :</p>
